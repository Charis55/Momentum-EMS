                  ...
                  <div className="event-card-body">
                    ...
                    <p className="event-meta-row" style={{ marginBottom: "12px", display: "flex", alignItems: "center", gap: "6px" }} tabIndex={0} aria-label={`Starts at: ${item.date || item.eventDate
                        ? typeof (item.date || item.eventDate) === "string"
                          ? new Date(item.date || item.eventDate).toLocaleString('en-US', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })
                          : new Date((item.date || item.eventDate)?.seconds * 1000).toLocaleString('en-US', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })
                        : "No Date"}`}>
